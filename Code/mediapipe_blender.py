...
svm_model_path = "C:\\Users\\hanna\\Documents\\GMU\CS682\\Final_Project\\Mediapipe_code\\mediapipe_svm_model.pkl"
...
def hands():
    ...
    print("Model loaded from 'mediapipe_svm_model.pkl'")
                ...
                if results.multi_hand_landmarks and results.multi_handedness:
                    for hand_landmarks, handedness in zip(results.multi_hand_landmarks, results.multi_handedness):
                        ...
                        if handedness.classification[0].label == 'Right':
                            ...
                            # Set hand size based on the average distances and smooth it
                            hand_size = sum(distance_vector[:5])/len(distance_vector[:5]) # First five distances appears to work best
                            ...
                            r_gesture = svm_model.predict([distance_vector])[0]
                            ...
                            if r_gesture == 'open_hand':
                                ...
                                if l_gesture != 'fist':
                                    ...
                                    if r_prev_hand_pos and r_prev_hand_size:
                                        dx = (hand_pos[0] - r_prev_hand_pos[0][0]) * 80
                                        dy = (hand_pos[1] - r_prev_hand_pos[0][1]) * 80
                                ...
                                if l_gesture != 'pinch':
                                    ...
                                    if r_prev_hand_pos and r_prev_hand_size:
                                        ...
                                        dy = (hand_pos[1] - r_prev_hand_pos[0][1]) * 20
                                        dz = (hand_size - r_prev_hand_size[0]) * 300
                                ...
                                if r_prev_hand_size and r_prev_hand_rot:
                                    r_change_in_size = (hand_size - r_prev_hand_size[0]) * 200
                                    
                                    rot = Matrix((hand_rot[0]*20, hand_rot[1]*20, hand_rot[2]*20)).to_quaternion()
                        ...
                        if handedness.classification[0].label == 'Left':
                            ...
                            # Get gesture prediction and draw hand landmarks
                            l_gesture = svm_model.predict([distance_vector])[0]
                            ...
                            if l_gesture == 'open_hand':
                                ...
                                if r_gesture != 'fist':
                                    ...
                                    if l_prev_hand_pos and l_prev_hand_size:
                                        dx = (hand_pos[0] - l_prev_hand_pos[0][0]) * 80
                                        dy = (hand_pos[1] - l_prev_hand_pos[0][1]) * 80
                                ...
                                if l_prev_hand_size and l_prev_hand_rot:
                                    l_change_in_size = (hand_size - l_prev_hand_size[0]) * 200
